...
<head>
  ...
  <!-- =======================================================
    ...
    Template URL: https://templatemag.com/TechVirt-bootstrap-admin-template/
...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo"><b>TECH<span>VIRT</span></b></a>
      <!--logo end-->
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu extended tasks-bar">
              ...
              <li>
                <a href="index.html#">
                  <div class="task-info">
                    <div class="desc">TechVirt Admin Panel</div>
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li >
            <a class="@yield('subject_select')" href="{{url('subject')}}">
    ...
    <footer class="site-footer">
      <div class="text-center">
        <p>
          &copy; Copyrights <strong>TechVirt</strong>. All Rights Reserved
        </p>
        <div class="credits">
          <!--
            You are NOT allowed to delete the credit link to TemplateMag with free version.
            You can delete the credit link only if you bought the pro version.
            Buy the pro version with working PHP/AJAX contact form: https://templatemag.com/TechVirt-bootstrap-admin-template/
            Licensing information: https://templatemag.com/license/
          -->
          Created by   <a href="https:localhost:8000">TechVirt Developer Team</a>
        </div>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      var unique_id = $.gritter.add({
        ...
        title: 'Welcome to TechVirt!',
        // (string | mandatory) the text inside the notification
        text: 'Hover me to enable the Close Button. You can hide the left sidebar clicking on the button next to the logo.',
        // (string | optional) the image to display on the left
        image: 'student/img/icon.jpg',
